import RelatedItems from '../components/RelatedItems';
  ...
  const carouseldata = [
    {
      id: '1',
      name: 'Evening Windset',
      url: "https://img.freepik.com/premium-psd/horizontal-website-banne_451189-110.jpg"
    },
    {
      id: '2',
      name: 'Beautiful Flowers',
      url: "https://img.freepik.com/free-vector/online-payment-banner-smartphone-credit-card_107791-2059.jpg"
    },
    {
      id: '3',
      name: 'Beautiful Windy Sunset',
      url: "https://img.freepik.com/premium-vector/modern-style-square-colorful-web-banner-design-premium-vector_656447-13.jpg"
    }
  ];

    
  const productdetailscarouseldata = [
    {
      id: '1',
      url: require('../assets/images/phones-cover.jpeg')
    },
    {
      id: '2',
      url: require('../assets/images/phones-cover.jpeg')
  ...
  const Categories = [
    {
      id: '1',
      name: 'I-Phone',
      url: require('../assets/images/figmassets/smartphone.png')
    },
    {
      id: '2',
      name: 'Samsung',
  ...
  const BestSellersData = [
    {
      id: '1',
      name: 'Iphone',
      url: require('../assets/images/home/smartphone.png')
    },
    {
      id: '2',
      name: 'Samsung',
      url: require('../assets/images/home/android.png')
    },
    {
      id: '3',
      name: 'IPhone',
